...
async function main() {
  ...
  if (unsupportedRequired.length) throw new Error(`Colunas legadas obrigatórias bloqueiam novos grupos: ${unsupportedRequired.join(', ')}. Execute novamente npm run migrate:communities com a versão 13.0.1 ou superior.`);
