...
assert(moduleText.includes("return res.redirect(302, portal ? '/meu-portal' : '/meu-portal/onboarding')"), 'Usuário autenticado não é redirecionado direto ao portal/onboarding.');
[
