  ...
  return `<a class="job-card" href="/vagas/${escapeHtml(vacancySlug(vacancy))}" data-track="ABRIR_VAGA" data-track-label="${escapeHtml(vacancy.titulo)}">
    ...
    <div>
      ...
      <div class="job-meta">
        ...
        ${Number(vacancy.idade_minima || 0) > 0 ? `<span class="meta-chip">Idade mínima: ${escapeHtml(vacancy.idade_minima)} anos</span>` : ''}
...
function jobDescriptionHtml(vacancy) {
  ...
  if (Number(vacancy.idade_minima || 0) > 0) requirements.unshift(`Idade mínima: ${Number(vacancy.idade_minima)} anos`);
...
async function vacancyDetailPage(req, res, next) {
  try {
    ...
    if (Number(vacancy.idade_minima || 0) > 0) required.unshift(`Idade mínima: ${Number(vacancy.idade_minima)} anos`);
            ...
            <div class="job-content">
              <article class="content-card">
                ...
                <div class="detail-grid">
                  ...
                  <div class="detail-item"><span>Idade mínima</span><strong>${escapeHtml(vacancy.idade_minima || 25)} anos</strong></div>
                </div>
              </article>
