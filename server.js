...
const ASSET_VERSION = `${String(process.env.ASSET_VERSION || '1300').trim()}-${APP_VERSION}`;
...
function portalHeader({ account = null, active = '', compactSearch = true } = {}) {
  ...
  return `<header class="directory-header">
    <div class="directory-utility"><div class="directory-container utility-inner"><span>Vagas e comunidades por estado, cidade e profissão</span><a href="/anunciar-vaga">Sua empresa precisa contratar? Conheça a Gênesis →</a></div></div>
    ...
    <div class="mobile-menu directory-mobile-menu" data-mobile-menu><nav class="directory-container"><a href="/grupos">Grupos</a><a href="/vagas">Vagas</a><a href="/grupos/categoria/free-lances">Free lances</a><a href="/cadastro">Criar conta</a><a href="/entrar">Entrar</a><a href="/anunciar-vaga">Para empresas</a></nav></div>
  </header><button class="menu-backdrop" data-menu-backdrop type="button" aria-label="Fechar menu"></button>`;
}
