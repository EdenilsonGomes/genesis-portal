...
- substitui **Primeiro emprego** e **Estágio e jovem aprendiz** por **Free lances** nas opções de grupos;
- corrige alinhamento, tamanhos e responsividade dos formulários de grupo e vaga;
- transforma benefícios da vaga em botões selecionáveis, mantendo um campo para outros detalhes;
- mostra erro amigável quando a imagem do grupo é inválida ou excede o limite;
- completa e valida as colunas necessárias em bancos que vieram do MVP antigo;
- adiciona teste dos fluxos de conta, envio de grupo, envio de vaga e upload inválido.
